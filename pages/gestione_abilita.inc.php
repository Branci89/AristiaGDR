    ...
    if($_SESSION['permessi'] < MODERATOR) {
        ...
        <div class="page_body">
            ...
            if(gdrcd_filter('get', $_POST['op']) == 'modify') {
                ...
                gdrcd_query("UPDATE abilita SET nome ='".gdrcd_filter('in', $_POST['nome'])."', descrizione ='".gdrcd_filter('in', $_POST['descrizione'])."', car = ".gdrcd_filter('num', $_POST['car']).", id_razza = ".gdrcd_filter('num', $_POST['id_razza'])." , categoria = '".gdrcd_filter('in', $_POST['categoria'])."' WHERE id_abilita = ".gdrcd_filter('num', $_POST['id_record'])." LIMIT 1"); ?>
                <div class="warning">
                    ...
                    <form action="main.php?page=gestione_abilita" method="post" class="form_gestione">
                        ...
                        <div class="form_field">
                            <select name="categoria">
                                <option value="Comune" <?php if($loaded_record['categoria'] == "Comune") { echo 'SELECTED'; } ?>>Comune</option>
                                <option value="Guerra" <?php if($loaded_record['categoria'] == "Guerra") { echo 'SELECTED'; } ?>>Guerra</option>
                            </select>
                        </div>
                        <!-- bottoni -->
            ...
            if(isset($_REQUEST['op']) === false) { /*Elenco record (Visualizzaione di base della pagina)*/
                ...
                //Lettura record
                $result = gdrcd_query("SELECT id_abilita, nome, car, categoria FROM abilita ORDER BY nome LIMIT ".$pagebegin.", ".$pageend."", 'result');
                    ...
                    <div class="elenco_record_gestione">
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="casella_titolo">
                                    <div class="titoli_elenco">Categoria</div>
                                </td>
                                <td class="casella_titolo">
