...
<div class="pagina_user_cambio_nome">
    ...
    <div class="page_body">
        ...
        if($_POST['op'] == 'new') {
            if(($email == gdrcd_filter_email($_POST['email'])) && ($pass == gdrcd_encript($_POST['new_pass'])) && ($iscriz >= strftime('%Y-%m-%d')) && (empty($_POST['new_name']) === false)) {
                ...
                if(gdrcd_query($result, 'num_rows') > 0) { ?>
                    ...
                    gdrcd_query("UPDATE tratti SET personaggio = '".gdrcd_filter('in', $_POST['new_name'])."' WHERE personaggio = '".$_SESSION['login']."'");
                    gdrcd_query("UPDATE clgpassionipersonaggio SET personaggio = '".gdrcd_filter('in', $_POST['new_name'])."' WHERE personaggio = '".$_SESSION['login']."'");
        ...
        <?php }
        /*Cambio nome admin: Brancix: non può cambiare il nome ad un SUPERUSER!*/
        ...
        if(isset($_POST['op']) === false) {
            ...
            if($_SESSION['permessi'] >= MODERATOR) {
                ...
                <div class="panels_box">
                    <div class="form_gioco">
                        <h2>Pannello dedicato da Moderatore in su</h2>
                        <form action="main.php?page=user_cambio_nome" method="post">
                            <div class="form_label">
