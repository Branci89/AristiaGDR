<div class="pagina_uffici">
        ...
        if ($confirm_updating) {
            ...
            if (isset($_POST['op']) === true) {
                ...
                if ((gdrcd_filter('get', $_REQUEST['pg']) == $_SESSION['login']) && (gdrcd_filter('get', $_POST['op']) == 'modify')) {
                    ...
                    gdrcd_query("UPDATE personaggio SET stato = '" . gdrcd_filter('in', $_POST['modifica_status']) . "', salute = " . gdrcd_filter('num', $_POST['modifica_salute']) . " , punti_fato= " . gdrcd_filter('num', $_POST['modifica_fato']) . " WHERE nome = '" . gdrcd_filter('in', $_REQUEST['pg']) . "'");
                ...
                $record = gdrcd_query("SELECT descrizione, storia, affetti, cognome, online_status, url_img, url_img_chat, url_media, blocca_media, stato, salute,salute_max, punti_fato FROM personaggio WHERE nome='" . gdrcd_filter('get',
                                $_REQUEST['pg']) . "'");
            }
        }
        ?>
                ...
                <div class="panels_box">
                    ...
                    if ($_SESSION['login'] == $_REQUEST['pg']) {
                        ...
                        <div class="form_gioco">
                            ...
                            <form action="main.php?page=scheda_modifica" method="post" style="border: 1px solid #b07e33;">
                                    ...
                                    <div><div class='form_label'>
                                        ...
                                        <div class='form_field'>
                                            <input class="healt_input" name="modifica_salute"
                                                   value="<?php echo $record['salute']; ?>"/>/ <?php echo $record['salute_max']; ?>
                                        </div></div>
                                    <div><div class='form_label'>
                                            <?php
                                            echo gdrcd_filter('out',
                                                    $MESSAGE['interface']['sheet']['profile']['punti_fato']);
                                            ?>
                                        </div>
                                        <div class='form_field'>
                                            <input class="healt_input" name="modifica_fato"
                                                   value="<?php echo $record['punti_fato']; ?>" />
                                        </div></div>
                                </div>
    ...
    <div class="link_back">
        ...
        echo gdrcd_filter('url',
                $_REQUEST['pg']);
        ?>"><?php echo gdrcd_filter('out', $MESSAGE['interface']['sheet']['link']['back']); ?></a>
    </div>
