...
<div class="pagina_frame_chat">
                        ...
                        <div style="width: 90%">
                            <form class="chat_form_branci" action="pages/chat.inc.php?ref=10&chat=yes" method="post" target="chat_frame" id="chat_form_messages">
                                <div class="chat_elements">
                                    ...
                                    <div class="casella_chat" style="width: 100%;">
                                        <input name="message" id="message" value="" style="width:100% !important;" />
                                        <br /><span class="casella_info">
    ...
    <?php if (($PARAMETERS['mode']['skillsystem'] == 'ON') || ($PARAMETERS['mode']['dices'] == 'ON')) { ?>
                                    <form  style="width: 50%" action="pages/chat.inc.php?ref=30&chat=yes" method="post" target="chat_frame" id="chat_form_actions">
        ...
        <?php if ($PARAMETERS['mode']['skillsystem'] == 'ON') { ?>
                                        ...
                                        <div class="casella_chat">
                                            ...
                                            ?>
                                            <select name="tratto_c" id="id_tratto">
                                                <option value="no_trait"></option>
                                                <?php 
                                        ...
                                        <div class="casella_chat">
                                            <input class="invio-chat" type="submit" value="<?php echo gdrcd_filter('out', $MESSAGE['interface']['forms']['submit']); ?>" />
    ...
    <?php } ?>
                                ...
                                <form style="width: 40%" action="pages/chat.inc.php?ref=30&chat=yes" method="post" target="chat_frame" id="chat_form_danno">
                                    <div style="border-left: 2px solid black;">
                                        ...
                                        <div class="casella_chat">
                                            <input style="width: 80px" name="val_forza" value="0" type="number"  min=0 max=100></input>
                                            </br>
                                    ...
                                    <div >
                                        ...
                                        <div class="casella_chat">
                                            <input style="width: 80px" name="val_bonus" type="number" min=0 max=100></input>
                                            </br>
