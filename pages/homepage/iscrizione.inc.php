    ...
    <div class="page_body">
        ...
        switch (gdrcd_filter('get', $_POST['fase']))
        {
                ...
                <div class="panels_box">
                    <div class="form_gioco">
                        <form action="<?php echo $_SERVER['SCRIPT_NAME'] . '?' . $_SERVER['QUERY_STRING']; ?>"
                            ...
                            <div class="form_label">
                                <?php echo gdrcd_filter('out', $MESSAGE['register']['fields']['nature']); ?>
                            </div>
                            <div class="form_field">
                                <select name="natura">
                            ...
                            <?php } ?>
                             <!-- Cultura -->
                            <div class="form_label">
                                <?php echo gdrcd_filter('out', $PARAMETERS['names']['culture']['sing'] . ' ' . $MESSAGE['register']['fields']['race']); ?>
                            </div>
                            <?php $culture_result = gdrcd_query("SELECT id_cultura, nome_cultura FROM cultura ORDER BY nome_cultura", 'result'); ?>
                            <div class="form_field">
                                <select name="cultura">
                                    <?php while ($row = gdrcd_query($culture_result, 'fetch')) { ?>
                                        <option value="<?php echo $row['id_cultura']; ?>" <?php if (gdrcd_filter('get', $_POST['cultura']) == $row['id_cultura']) {
                                            echo 'SELECTED';
                                        } ?>>
                                            <?php echo gdrcd_filter('out', $row['nome_cultura']); ?>
                                        </option>
                                    <?php } ?>
                                </select>
                            </div>
                            ...
                            <div class="form_label">
                                ...
                                <br />Nota: Le statistiche partono con una base di 10!!
                            </div>
                            <div class="form_field">
                                <table>
                                    <tr>
                                        <td>
                                            ...
                                            <br/>
                                            <select name="car0">
                                                <?php for ($i = 0; $i <= $PARAMETERS['settings']['initial_cars_cap']; $i++) { ?>
            ...
            case 2:
                ...
                <div class="panels_box">
                    ...
                    if ((gdrcd_filter('num', $_POST['car0']) + gdrcd_filter('num', $_POST['car1']) + gdrcd_filter('num', $_POST['car2']) + gdrcd_filter('num', $_POST['car3']
                            ) + gdrcd_filter('num', $_POST['car4']) ) != $PARAMETERS['settings']['cars_sum']) {
                        $ok = false;
                        ...
                        <div class="form_gioco">
                            <form action="<?php echo $_SERVER['SCRIPT_NAME'] . '?' . $_SERVER['QUERY_STRING']; ?>"
                                ...
                                <div class="form_submit">
                                    ...
                                    <input type="hidden" name="cultura"
                                           value="<?php echo gdrcd_filter('out', $_POST['cultura']) ?>"/>
                                    <input type="hidden" name="natura"
                                           value="<?php echo gdrcd_filter('out', $_POST['natura']) ?>"/>
                    ...
                    <?php } else {
                        $r_gen =  'm';
                        $cultura = gdrcd_query("SELECT nome_cultura FROM cultura WHERE id_cultura =". (0+ gdrcd_filter('num', $_POST['cultura'])) . " LIMIT 1 " );
                        ...
                        <div class="elenco_gioco">
                            <table style="width: 80%">
                                ...
                                <tr>
                                    <td class='casella_elemento'>
                                        <div class='elementi_elenco'>
                                            <?php echo gdrcd_filter('out', $_POST['natura']) == 'hg' ? 'Semi-dio':'Mortale' ; ?>
                                        </div>
                                    </td>
                                </tr>
                                 <tr>
                                    <td class='casella_elemento'>
                                        <div class='elementi_elenco'>
                                            <?php echo gdrcd_filter('out', $cultura['nome_cultura']) ?>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td class='casella_elemento'>
                                        <div class='elementi_elenco'>
                                            <?php echo gdrcd_filter('out', $PARAMETERS['names']['stats']['car0'] . ': '.$PARAMETERS['settings']['cars_base'].' + ' . $_POST['car0']) ?>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td class='casella_elemento'>
                                        <div class='elementi_elenco'>
                                            <?php echo gdrcd_filter('out', $PARAMETERS['names']['stats']['car1'] . ': '.$PARAMETERS['settings']['cars_base'].' + ' . $_POST['car1']) ?>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td class='casella_elemento'>
                                        <div class='elementi_elenco'>
                                            <?php echo gdrcd_filter('out', $PARAMETERS['names']['stats']['car2'] . ': '.$PARAMETERS['settings']['cars_base'].' + ' . $_POST['car2']) ?>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td class='casella_elemento'>
                                        <div class='elementi_elenco'>
                                            <?php echo gdrcd_filter('out', $PARAMETERS['names']['stats']['car3'] . ': '.$PARAMETERS['settings']['cars_base'].' + ' . $_POST['car3']) ?>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td class='casella_elemento'>
                                        <div class='elementi_elenco'>
                                            <?php echo gdrcd_filter('out', $PARAMETERS['names']['stats']['car4'] . ': '.$PARAMETERS['settings']['cars_base'].' + ' . $_POST['car4']) ?>
                                        </div>
                                    </td>
                                </tr>
            ...
            case 3:
                ...
                if ((gdrcd_filter('num', $_POST['car0']) + gdrcd_filter('num', $_POST['car1']) + gdrcd_filter('num', $_POST['car2']) + gdrcd_filter('num', $_POST['car3']) + gdrcd_filter('num', $_POST['car4'])) != $PARAMETERS['settings']['cars_sum']) {
                    echo '<div class="error">' . gdrcd_filter('out', $MESSAGE['register']['fields']['stats_info'] . ' ' . $PARAMETERS['settings']['cars_sum']) . '</div>';
                } else {
                    ...
                    if ($ok) {
                            ...
                            gdrcd_query("INSERT INTO personaggio (nome, cognome, pass, data_iscrizione, email, sesso, natura, id_razza, id_cultura, car0, car1, car2, car3, car4, car5, salute, salute_max, soldi, esperienza $lastpasschange_field , lastExp) 
                            VALUES ('" . gdrcd_safe_name($_POST['nome']) . "', '" . gdrcd_safe_name($_POST['cognome']) . "', '" . gdrcd_encript($pass) . "', NOW(), '" . gdrcd_encript($email) . "', 'm', '". gdrcd_filter('out', $_POST['natura'])."' , " . gdrcd_filter('num', $_POST['razza']) . ", ".gdrcd_filter('num', $_POST['cultura'])." , " . $PARAMETERS['settings']['cars_base']+gdrcd_filter('num', $_POST['car0']) . ", " . $PARAMETERS['settings']['cars_base']+gdrcd_filter('num', $_POST['car1']) . ", " . $PARAMETERS['settings']['cars_base']+gdrcd_filter('num', $_POST['car2']) . ", " . $PARAMETERS['settings']['cars_base']+gdrcd_filter('num', $_POST['car3']) . ", " . $PARAMETERS['settings']['cars_base']+gdrcd_filter('num', $_POST['car4']) . ",0, " . gdrcd_filter('num', $PARAMETERS['settings']['max_hp']) . ", " . gdrcd_filter('num', $PARAMETERS['settings']['max_hp']) . ", " . gdrcd_filter('num', $PARAMETERS['settings']['first_money']) . ", " . gdrcd_filter('num', $PARAMETERS['settings']['first_px']) . " $lastpasschange_value, NOW())");
