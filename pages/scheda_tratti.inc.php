...
<div class="pagina_scheda" >
    <header class="w3-header w3-center">
        ...
        if (isset($_POST['submit']) && $_POST['op'] == 'point') {
            ...
            if ((int) $point['da_spendere'] >= array_sum($values)) {
                //Qui quindi aggiorniamo le statistiche con i punticini: 
    ...
    <div class="w3-row w3-padding w3-border" >
        ...
        while ($row = gdrcd_query($result, 'fetch')) {
            ...
            echo ''
            . '<div class="tratti_voce_label w3-third">' . $anag_tratto['nome_tratto'] . '</div>'
            . '<div class="tratti_voce w3-half">'
        ...
        <div style="padding: 25px;">
            ...
            <div class="w3-border">
                ...
                <form method="post" action="main.php?page=scheda_tratti&pg=<?php echo gdrcd_filter('url', $_REQUEST['pg']); ?>">
                    <p>Hai <?php echo $tratti['da_spendere'] ?> da distribuire</p>
...
<?php } ?>
    ...
    ?>
                ...
                <div class="form_field">
                    <input name="valore" type="number" min="0" max="20"></div>
                </div>
                <div class="form_submit">
