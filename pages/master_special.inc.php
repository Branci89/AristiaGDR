...
<div class="page_frame_top">
    ...
    <div class="page_title">
        <h2 class="w3-center">Eventi Speciali</h2>
    </div>
    ...
    $query = "SELECT data_da, titolo, testo FROM news WHERE speciale=1 and (data_da >= CURDATE() and CURDATE() <= data_a) ORDER BY data_da";
