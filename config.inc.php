...
$PARAMETERS['info']['dbadmin_name'] = 'Spartacus'; //nome del responsabile del database
 ...
 *
 */
$PARAMETERS['themes']['kind_of_layout'] = 'left-top-right';
...
$PARAMETERS['names']['culture']['sing'] = 'Cultura'; //nome delle Culture nel gioco (singolare)
$PARAMETERS['names']['culture']['plur'] = 'Culture'; //nome delle Culture nel gioco (plurale)
...
$PARAMETERS['settings']['first_money'] = 0;//Quantita' di denaro iniziale per i PG
...
$PARAMETERS['administration']['passioni']['text'] = 'Gestione Passioni';
$PARAMETERS['administration']['passioni']['url'] = 'main.php?page=gestione_passioni';
$PARAMETERS['administration']['passioni']['access_level'] = SUPERUSER;
$PARAMETERS['administration']['tratti_caratteriali']['text'] = 'Gestione Tratti Caratteriali';
$PARAMETERS['administration']['tratti_caratteriali']['url'] = 'main.php?page=gestione_tratti';
$PARAMETERS['administration']['tratti_caratteriali']['access_level'] = SUPERUSER;
