...
$MESSAGE['homepage']['main_content']['site_title'] = 'ARISTIA';
$MESSAGE['homepage']['main_content']['site_subtitle'] = '<span></span>';
$MESSAGE['homepage']['main_content']['welcome'] = 'Benvenuto ad Aristia!';
...
$MESSAGE['register']['fields']['natura'] = 'Natura del personaggio';
$MESSAGE['register']['fields']['nature_mortal'] = 'Mortale';
$MESSAGE['register']['fields']['nature_halfgod'] = 'Semi-Divino';
...
$MESSAGE['interface']['sheet']['profile']['experience'] = 'Gloria';
$MESSAGE['interface']['sheet']['profile']['punti_fato'] = 'Punti Fato';
$MESSAGE['interface']['sheet']['profile']['status'] = 'Note Fato';
$MESSAGE['interface']['sheet']['profile']['healt'] = 'Punti Salute';
...
$MESSAGE['interface']['sheet']['menu']['experience'] = 'Gloria';
$MESSAGE['interface']['sheet']['menu']['inventory'] = 'Oggetti';
...
$MESSAGE['interface']['sheet']['menu']['detail']='BG';
...
$MESSAGE['interface']['sheet']['info_skill_cost'] = 'Il costo di incremento di un\'abilità è pari a ' . $PARAMETERS['settings']['px_x_rank'] . 'GLO  e di '.$PARAMETERS['settings']['px_x_rank_over_20']. ' Oltre il grado 20.';
$MESSAGE['interface']['sheet']['avalaible_xp'] = 'Gloria Disponibile';
$MESSAGE['interface']['sheet']['px']['page_name'] = 'Riepilogo Gloria';
$MESSAGE['interface']['sheet']['px']['px'] = 'GLO';
...
/*PASSIONI*/
$MESSAGE['interface']['administration']['passioni']['page_name'] = 'Gestione Passioni';
$MESSAGE['interface']['administration']['passioni']['submit']['insert'] = 'Inserisci';
$MESSAGE['interface']['administration']['passioni']['submit']['edit'] = 'Modifica';
$MESSAGE['interface']['administration']['passioni']['submit']['undo'] = 'Annulla';
$MESSAGE['interface']['administration']['passioni']['name'] = 'Nome';
$MESSAGE['interface']['administration']['passioni']['infos'] = 'Descrizione';
$MESSAGE['interface']['administration']['passioni']['is_commons'] = 'Comune';
$MESSAGE['interface']['administration']['passioni']['link']['back'] = 'Torna all\'elenco';
$MESSAGE['interface']['administration']['passioni']['link']['new'] = 'Nuova Passione';
$MESSAGE['interface']['administration']['passioni']['for_who'] = 'Verso chi';

/*TRATTI CARATTERIALI*/
$MESSAGE['interface']['administration']['tratti']['page_name'] = 'Gestione Tratti';
$MESSAGE['interface']['administration']['tratti']['submit']['insert'] = 'Inserisci';
$MESSAGE['interface']['administration']['tratti']['submit']['edit'] = 'Modifica';
$MESSAGE['interface']['administration']['tratti']['submit']['undo'] = 'Annulla';
$MESSAGE['interface']['administration']['tratti']['name'] = 'Nome';
$MESSAGE['interface']['administration']['tratti']['infos'] = 'Descrizione';
$MESSAGE['interface']['administration']['tratti']['link']['back'] = 'Torna all\'elenco';
$MESSAGE['interface']['administration']['tratti']['link']['new'] = 'Nuovo Tratto Caratteriale';
...
$MESSAGE['event'][PX] = 'Gloria assegnata';
$MESSAGE['event'][DELETEPG] = 'Personaggi cancellati';
$MESSAGE['event'][CHANGEDNAME] = 'Cambi nome';

/*Dichiarazioni per news*/
$MESSAGE['interface']['news']['title_page']='News';
$MESSAGE['interface']['administration']['news']['page_name']='Gestione news';
$MESSAGE['interface']['administration']['news']['date']='Data';
$MESSAGE['interface']['administration']['news']['titolo']='Titolo';
$MESSAGE['interface']['administration']['news']['infos']='Testo';
$MESSAGE['interface']['administration']['news']['link']['back']='Torna all\'elenco';
$MESSAGE['interface']['administration']['news']['link']['new']='Nuova news';
$MESSAGE['interface']['administration']['forms']['submit']='Invia nuova news';
$MESSAGE['interface']['administration']['forms']['modify']='Modifica news';
